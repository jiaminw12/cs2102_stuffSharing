<?php
  ...
  if ($page != "profile" && $page != "item" && $page != "bid") {
    $page = "profile";
  }
    ...
    <div class="row"> 
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="Item.php?id=<?php echo $project->getId(); ?>">
    ...
    <div class="row"> 
      ...
      <tbody>
        <?php foreach ($contributionList as $contribution) {
          ...
          $project = ItemController\getProject($projectId);
        ?>
        <tr>
          <td>
          ...
          <?php if (UserController\canActiveUserModifyContribution($contribution->getId())) {?>
              <td>
              <a href="edit_Bid.php?id=<?php echo $contribution->getId() ?>">
